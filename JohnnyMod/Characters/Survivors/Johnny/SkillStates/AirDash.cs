...
{
    //Airdash is a special aerial version of step dash, it is faster, goes further and has some invulnerability.
    public class AirDash : BaseSkillState
    {
        ...
        public override void OnEnter()
        {
            ...
            if (NetworkServer.active)
            {
                ...
                characterBody.AddTimedBuff(RoR2Content.Buffs.HiddenInvincibility, 0.3f * duration);
                characterBody.AddTimedBuff(RoR2Content.Buffs.Intangible, 0.3f * duration);
            }
        }
